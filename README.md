...
<p align="center">
I am a passionate **Java Full Stack Developer** specializing in backend architecture using **Spring Boot** and creating dynamic user interfaces with **React.js**. My focus is on writing clean code, designing robust REST APIs, and implementing secure authentication systems. I am currently bridging the gap between development and deployment using **Docker** and cloud platforms.
</p>
...
| **🗄️ Database** | ![MySQL](https://img.shields.io/badge/MySQL-005C84?style=flat-square&logo=mysql&logoColor=white) ![JDBC](https://img.shields.io/badge/JDBC-007396?style=flat-square&logo=java&logoColor=white) |
